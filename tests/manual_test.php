...
global $CFG;
require_once($CFG->dirroot . '/auth/saml2sso/auth.php');

/**
 * saml2sso authentication tests class.
 *
 * @package    auth_saml2sso
 * @category   test
 * @copyright  2014 Gilles-Philippe Leblanc <gilles-philippe.leblanc@umontreal.ca>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auth_saml2sso_testcase extends advanced_testcase {

    /** @var auth_plugin_saml2sso Keeps the authentication plugin. */
    ...
    protected function setUp() {
        ...
        set_config('expiration', '1', 'auth_saml2sso');
        set_config('expiration_warning', '2', 'auth_saml2sso');
        set_config('expirationtime', '30', 'auth_saml2sso');
    ...
    public function test_user_update_password() {
        ...
        $this->assertGreaterThanOrEqual($expectedtime, get_user_preferences('auth_saml2sso_passwordupdatetime', 0, $user->id));
